...
Namespace InteractiveRangeSelect
    ...
    Public Partial Class Form1
        ...
        Private minRange, maxRange As Date
        ...
        Private Sub SetCursor(ByVal dateTime As Date)
        ...
        Private Sub AdjustRange(ByVal dateTime As Date)
        ...
        Private Sub PopulateDataSet()
            ...
            For i As Integer = 0 To 100 - 1
                dt.Rows.Add(New Object() {Date.Now.Date.AddMinutes(i), rnd.NextDouble() * 5 + 15})
            Next
