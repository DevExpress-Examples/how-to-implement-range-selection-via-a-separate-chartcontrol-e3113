...
Namespace InteractiveRangeSelect
    Partial Public Class Form1
        ...
        Private Sub chartSelectRange_MouseDown(ByVal sender As Object, ByVal e As MouseEventArgs) _
        Handles chartSelectRange.MouseDown
        ...
        Private Sub chartSelectRange_MouseUp(ByVal sender As Object, ByVal e As MouseEventArgs) _
        Handles chartSelectRange.MouseUp
            If Diagram Is Nothing Then
                Return
            End If
            draggingStart = False
        ...
        Private Sub chartSelectRange_MouseMove(ByVal sender As Object, ByVal e As MouseEventArgs) _
        Handles chartSelectRange.MouseMove
            If Diagram Is Nothing Then
                Return
            End If
        ...
        Private Sub chartSelectRange_CustomPaint(ByVal sender As Object, ByVal e As CustomPaintEventArgs) _
        Handles chartSelectRange.CustomPaint
            If Diagram Is Nothing Then
                Return
            End If
            Dim leftBottom As ControlCoordinates = _
                Diagram.DiagramToPoint(minRange, Convert.ToDouble(Diagram.AxisY.Range.MinValue))
            Dim leftTop As ControlCoordinates = _
                Diagram.DiagramToPoint(minRange, Convert.ToDouble(Diagram.AxisY.Range.MaxValue))
            Dim rightTop As ControlCoordinates = _
                Diagram.DiagramToPoint(maxRange, Convert.ToDouble(Diagram.AxisY.Range.MaxValue))

            Dim leftZero As ControlCoordinates = _
                Diagram.DiagramToPoint(Convert.ToDateTime(Diagram.AxisX.Range.MinValue), Convert.ToDouble(Diagram.AxisY.Range.MaxValue))
            Dim rightMax As ControlCoordinates = _
                Diagram.DiagramToPoint(Convert.ToDateTime(Diagram.AxisX.Range.MaxValue), Convert.ToDouble(Diagram.AxisY.Range.MaxValue))
            ...
            e.Graphics.FillRectangle(highlight, leftZero.Point.X, leftZero.Point.Y, _
                                     leftTop.Point.X - leftZero.Point.X - 1, height)
            e.Graphics.FillRectangle(highlight, leftTop.Point.X + width + 1, leftTop.Point.Y, _
